...
def fetch_poster(movie_id):
    response = requests.get(f'https://api.themoviedb.org/3/movie/{movie_id}?api_key=ce4cc856e935509a5801b0b99e172223')
    data = response.json()
...
def recommend(movie):
    ...
    return recommend_movies,recommeded_movies_posters
